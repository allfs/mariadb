...
then
  ...
  langdir=`find_in_basedir --dir errmsg.sys share/english share/mariadb-galera/english`
  if test -z "$langdir"
  then
    cannot_find_file errmsg.sys $basedir/share/english $basedir/share/mariadb-galera/english
    exit 1
  fi
  pkgdatadir=`find_in_basedir --dir fill_help_tables.sql share share/mariadb-galera`
  if test -z "$pkgdatadir"
  then
    cannot_find_file fill_help_tables.sql $basedir/share $basedir/share/mariadb-galera
    exit 1
  fi
